...
from gallery_dl.extractor import mgrenders


__tests__ = (
{
    "#url"     : "https://a.mg-renders.net/2013/01/mondai-ji-tachi-ga-isekai-kara-kuru-so_65.html",
    "#class"   : mgrenders.MgrendersPostExtractor,
    "#results" : "https://2.bp.blogspot.com/-EYJ-6Di_n3Y/UPZEUBqK-cI/AAAAAAAAE98/aLU7jD9wcDk/s0/Kuro+Usagi+Render+3+by+MG.png",

    "date"     : "dt:2013-01-08 20:08:00",
    "extension": "png",
...
{
    "#url"     : "https://h.mg-renders.net/2014/04/tiffania-westwood-render-ecchi-hentai.html",
    "#class"   : mgrenders.MgrendersPostExtractor,
    "#results" : "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhXC-mWlNu-WLCRwwPlf9iH9DDTwo0BN3i3DzGfQHQVPsfkIfA6bYoU0BxCwFNq93dfFMXicTUtoaL-_MbRkQoJL4X4ACOydPDeHM68ilWJbiOBL4OM-qG3dH6PTu10HXs4tEL6tZc4OpA/s0/Zero+no+Tsukaima+-+Tiffania+Westwood+Render+7+%255BFujii+Masahiro%255D.png",

    "date"     : "dt:2020-11-11 16:15:00",
    "extension": "png",
...
{
    "#url"     : "https://a.mg-renders.net/search/label/Date%20a%20Live?&max-results=48",
    "#class"   : mgrenders.MgrendersSearchExtractor,
    "#pattern" : mgrenders.MgrendersPostExtractor.pattern,
    "#count"   : 98,
},

{
    "#url"     : "https://h.mg-renders.net/search/label/Zero%20no%20Tsukaima?&max-results=48",
    "#class"   : mgrenders.MgrendersSearchExtractor,
    "#results" : (
        "https://h.mg-renders.net/2014/04/tiffania-westwood-render-ecchi-hentai.html",
        "https://h.mg-renders.net/2014/10/zero-no-tsukaima-tiffania-westwood.html",
    ),
},
